...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            tinymce.init({
                selector: 'textarea#description, textarea#short_description, textarea#TechnicalSpecification',
                height: 200,
                width: "100%",
                plugins: 'image imagetools media wordcount save fullscreen code table lists link hr advlist',
