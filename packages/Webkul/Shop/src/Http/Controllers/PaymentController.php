...
class PaymentController extends Controller
{
	...
	public function index()
    {
		...
		$amount = str_replace(',', '', $amount);
			...
			$html = '<form action="'.$action.'" id="payment_form_submit" method="post">
					...
					<input type="hidden" id="surl" name="surl" value="https://demo.onlinereviews.org.uk/redirect/success" />
					<input type="hidden" id="furl" name="furl" value="https://demo.onlinereviews.org.uk/redirect/fail" />
					<input type="hidden" id="curl" name="curl" value="https://demo.onlinereviews.org.uk/redirect/fail" />
    ...
    {
        session()->flash('error', 'Payubiz payment has been canceled.');
