...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    // Category
    Route::get('residential-doors', 'Webkul\Shop\Http\Controllers\CategoryController@residentialDoors')->name('shop.category.residential-doors');

    Route::get('commercial-doors', 'Webkul\Shop\Http\Controllers\CategoryController@commercialDoors')->name('shop.category.commercial-doors');

    Route::get('doors', 'Webkul\Shop\Http\Controllers\CategoryController@door')->name('shop.category.doors');

    Route::get('windows', 'Webkul\Shop\Http\Controllers\CategoryController@window')->name('shop.category.windows');

    Route::get('category/{slug}', 'Webkul\Shop\Http\Controllers\CategoryController@getCategories')->name('shop.category.category-list');

    Route::get('/getProductByCategory', 'Webkul\Shop\Http\Controllers\CategoryController@getProductByCategory');  

    Route::get('/getCategoryByProduct', 'Webkul\Shop\Http\Controllers\CategoryController@getCategoryByProduct'); 

    Route::post('/lead-form', 'Webkul\Shop\Http\Controllers\LeadController@leadForm');    

    Route::get('aluminium-windows', 'Webkul\Shop\Http\Controllers\CategoryController@aluminiumWindow')->name('shop.category.aluminium-windows');

    Route::get('steel-windows', 'Webkul\Shop\Http\Controllers\CategoryController@steelWindow')->name('shop.category.steel-windows');

    Route::post('/door-form', 'Webkul\Shop\Http\Controllers\CategoryController@doorForm');

    Route::get('/contact-us', 'Webkul\Shop\Http\Controllers\HomeController@contactUs')->defaults('_config', [
        'view' => 'shop::home.contact-us'
    ])->name('shop.home.contact-us');

    Route::post('/save-contact-us', 'Webkul\Shop\Http\Controllers\HomeController@saveContactData');

    Route::post('/ask-the-expert', 'Webkul\Shop\Http\Controllers\HomeController@asktheexpert');

    Route::post('/payu_payment', 'Webkul\Shop\Http\Controllers\PaymentController@index')->name('shop.payment.payupayment');

    Route::post('/paymentresponse', 'Webkul\Shop\Http\Controllers\PaymentController@paymentresponse')->defaults('_config', [
        'view' => 'shop::payment.payment-response'
    ])->name('shop.payment.payment-response');

    Route::post('/redirect/success', 'Webkul\Shop\Http\Controllers\PaymentController@success');

    Route::post('/redirect/fail', 'Webkul\Shop\Http\Controllers\PaymentController@cancel');

    
    Route::get('/brochures', 'Webkul\Shop\Http\Controllers\HomeController@brochures')->defaults('_config', [
        'view' => 'shop::home.brochure'
    ]);

    Route::post('/login', 'Webkul\Shop\Http\Controllers\LoginController@check');

    Route::post('/register', 'Webkul\Shop\Http\Controllers\LoginController@register');


    // Route::any('residential-door/{slug}', 'Webkul\Shop\Http\Controllers\CategoryController@getCategoryList')->name('shop.category.category-list');

    Route::post('/reach-out', 'Webkul\Shop\Http\Controllers\HomeController@reachOut')->name('shop.home.reach-out');

    Route::get('/get-dealer', 'Webkul\Shop\Http\Controllers\HomeController@getDealer')->name('shop.home.locate-dealer');

    Route::get('/get-zipcode', 'Webkul\Shop\Http\Controllers\ProductController@getZipcode');

    Route::get('/model-description', 'Webkul\Shop\Http\Controllers\ProductController@getModelDescription');

    Route::get('/store-locator', 'Webkul\Shop\Http\Controllers\HomeController@storeLocator')->defaults('_config', ['view' => 'shop::home.store-locator'])->name('shop.home.store-locator');

    Route::post('/newsletter', 'Webkul\Shop\Http\Controllers\NewsletterController@newsletter');

    Route::get('/checkmobileexist', 'Webkul\Shop\Http\Controllers\HomeController@checkmobileexist');
    /* Static Pages */

    Route::get('/about-us', 'Webkul\Shop\Http\Controllers\PageController@aboutUs')->defaults('_config', ['view' => 'shop::page.about-us'])->name('shop.page.about-us');

    Route::get('/faq', 'Webkul\Shop\Http\Controllers\PageController@faq')->defaults('_config', ['view' => 'shop::page.faq'])->name('shop.page.faq');
    ...
    Route::get('image/{filename}', 'Webkul\Shop\Http\Controllers\HomeController@displayImage')->name('image.displayImage');
    ...
    /* OTP Based Login */
        ...
        //Route::post('customer/submitRegisterForm', 'Webkul\Customer\Http\Controllers\RegistrationController@submitRegisterForm');

        //Route::post('customer/submitotp', 'Webkul\Customer\Http\Controllers\RegistrationController@submitotp');
    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::post('login', 'Webkul\Customer\Http\Controllers\SessionController@create')->defaults('_config', [
            'redirect' => 'customer.overview.index'
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                // Customer Overview
                Route::get('overview', 'Webkul\Customer\Http\Controllers\CustomerController@overview')->defaults('_config', [
                    'view' => 'shop::customers.account.overview.index'
                ])->name('customer.overview.index');

                // Customer Browsing History
                Route::get('browsing-history', 'Webkul\Customer\Http\Controllers\CustomerController@overview')->defaults('_config', [
                    'view' => 'shop::customers.account.browsinghistory.index'
                ])->name('customer.browsinghistory.index');

                Route::get('coupon', 'Webkul\Customer\Http\Controllers\CustomerController@getCoupon')->defaults('_config', [
                    'view' => 'shop::customers.account.coupon.index'
                ])->name('customer.coupon.index');
