            ...
            <div class="discount-control">
                <form class="coupon-form" method="post" @submit.prevent="applyCoupon">
                    <div class="control-group" :class="[error_message ? 'has-error' : '']">
                        <input type="text" class="code-input2" v-model="coupon_code" name="code" placeholder="{{ __('shop::app.checkout.onepage.enter-coupon-code') }}">

                        <div class="control-error">@{{ error_message }}</div>
                    </div>

                    <button class="apply" :disabled="disable_button">Apply</button>
                </form>
            </div>
        ...
        Vue.component('coupon-component', {
            ...
            methods: {
                ...
                redirectIfCartPage: function() {
                 ...
                 redirectIfCheckoutPage: function() {
                    if (this.route_name != 'shop.checkout.onepage.index')
                        return;
