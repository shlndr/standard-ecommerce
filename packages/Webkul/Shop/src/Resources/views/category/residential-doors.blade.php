...
<div class="banner-slider residential cf">
	<div class="banner-content">
				<img src="{{ asset('/themes/velocity/assets/images/residential-doors/residential-doors-bg.jpg') }}" alt="Banner 1" class="">
			</div>
	<!-- <div class="owl-carousel owl-theme owl1">
		<div class="item">
			<div class="banner-content">
				<source type="image/webp" srcset="{{ asset('/themes/velocity/assets/images/residential-doors/residential-doors-bg.webp') }}">
				<img src="{{ asset('/themes/velocity/assets/images/residential-doors/residential-doors-bg.jpg') }}" alt="Banner 1" class="">
				<div class="txt">
					<div class="middle">
						<div class="lt0">
							<span class="title1">Fusion Doors</span>
							<h2 class="title0">Steel Bhi Style Bhi</h2>
...
<section class="top-sect">
	<div class="container">
		<h2><strong>Residential Doors</strong></h2> 
	  <h1>Make ‘Room’ for Beautiful Residential Doors </h1>
...
<section class="top-sect">
	<div class="container">
<h2>Types of Residential Doors</h2>
</section>
<?php 
	$i = 2;
...
<section class="faqs">
	<div class="container demo">
		<h2>
			...
			<a href="#" style="color:#fff" class="btn-blue">View All</a>
		</h2> 
