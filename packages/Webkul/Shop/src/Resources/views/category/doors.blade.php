...
<section class="every-door door-new">
	<div class="container">
		<div class="every-row red-bg">
			<div class="lt"><span>Make A Room For</span>
				<h2>Beautiful doors</h2>
				<p>On a journey to bring you the timeless<br> stories behind the best doors of India</p>
			</div>
			<div class="rt">
				<img src="{{ asset('/themes/velocity/assets/images/room-door-img.jpg') }}" alt="">
			</div>
	...
	<div class="container">
		<div class="">
			...
			<div class="col-lg-12 col-sm-12 catDtl">
				<div class="img">
					<img src="{{ asset('/themes/velocity/assets/images/catDtl-1.png') }}" alt="">
				</div>
				<div class="txt">
					...
					<a href="{{ url('category/residential-doors') }}"><span>Residential</span> Doors</a><i class="fas fa-arrow-right"></i>
				</div>
				<div class="clear"></div>
			</div>
			<div class="col-lg-12 col-sm-12 catDtl">
				<div class="img">
					<img src="{{ asset('/themes/velocity/assets/images/catDtl-2.png') }}" alt="">
				</div>
				<div class="txt">
					...
					<a href="{{ url('category/commercial-doors') }}"><span>Commercial</span> Doors</a><i class="fas fa-arrow-right"></i>
				</div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<div class="container-980">
			<div class="inner-from">
				...
				<div class="formbx frmp">
					<form method="post" id="doorFormLpVal" novalidate="novalidate">
						<div class="formbx">
