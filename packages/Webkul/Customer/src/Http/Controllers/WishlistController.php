...
class WishlistController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        //                 ->select('product_flat.*','wishlist.*')
        //                  ->join('product_flat', 'product_flat.product_id', '=', 'wishlist.product_id')  
        //                 ->where('wishlist.customer_id','=', auth()->guard('customer')->user()->id)
        //                 ->get()->toArray();
        
        //$wishlistItems = json_decode(json_encode($wishlistItems),true);
