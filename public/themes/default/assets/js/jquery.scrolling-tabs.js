  ...
  var tabElements = (function () {
    ...
    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance, settings) {
      var $tabsContainer = $('<div class="scrtabs-tab-container"> </div>'),
          ...
          rightArrowContent = settings.rightArrowContent || '<div class="scrtabs-tab-scroll-arrow scrtabs-tab-scroll-arrow-right"><span class="' + settings.cssClassRightArrow + '"></span></div> <div class="clear"</div>',
...
/*
  Implementation code, NOT part of plugin
*/
;(function() {
  'use strict';
  ...
  function activate() {
    ...
    $('.nav-tabs')
      ...
      .on('ready.scrtabs', function() {
        $('.tab-content').show();
        $('.nav-tabs').scrollingTabs('refresh'); // handle iframe adding scrollbar after init
      });
  }
}());
